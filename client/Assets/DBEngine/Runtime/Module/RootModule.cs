...
namespace DBEngine
{
    ...
    public sealed class RootModule : MonoBehaviour
    {
        ...
        [SerializeField]
        private string textHelperTypeName = "DBEngine.DefaultTextHelper";

        [SerializeField]
        private string logHelperTypeName = "DBEngine.DefaultLogHelper";

        [SerializeField]
        private string jsonHelperTypeName = "DBEngine.DefaultJsonHelper";
