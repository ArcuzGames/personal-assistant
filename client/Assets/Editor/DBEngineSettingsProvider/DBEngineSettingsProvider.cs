...
public static class DBEngineSettingsProvider  
{  
    [MenuItem("DBEngine/Settings/DBEngine UpdateSettings", priority = -1)]
    public static void OpenSettings() => SettingsService.OpenProjectSettings("Project/DBEngine/UpdateSettings");
    
    private const string SettingsPath = "Project/DBEngine/UpdateSettings";  
