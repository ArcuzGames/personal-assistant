...
namespace DBEngine.Editor.UI
{
    ...
    [CreateAssetMenu(menuName = "DBEngine/ScriptGeneratorSetting", fileName = "ScriptGeneratorSetting")]
    public class ScriptGeneratorSetting : ScriptableObject
    {
        ...
        [MenuItem("DBEngine/Create ScriptGeneratorSetting")]
